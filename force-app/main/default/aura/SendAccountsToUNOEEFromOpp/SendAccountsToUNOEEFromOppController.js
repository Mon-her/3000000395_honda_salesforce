    ...
    doInit: function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                // Call the validation function passing the profileName
                this.performValidation(component, profileName);
            } else {
                // Handle error
            }
        });
    ...
    handleRecordUpdated: function(component, event, helper) {
        ...
        if(eventParams.changeType === "LOADED") {
           // record is loaded (render other component which needs record data value)
            ...
            if (component.get("v.record.Amount") == null && component.get("v.CurrentUser.Profile.Name") != 'Asistentes service autos'){
                component.set("v.mensaje", 'Esta Oportunidad no tiene establecido un Importe!');
                //button.set('v.disabled',true);
                return;
            }*/
            ...
            if (component.get("v.simpleRecord.Facturar_a_nombre_de__r.Codigo_Postal__c") == null )
            {
                component.set("v.mensaje", 'La cuenta a facturar no tiene codido postal, porvvv favor llénela antes de continuar!');
                return;
            }
